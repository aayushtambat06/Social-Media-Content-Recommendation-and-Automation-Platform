    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
          ...
          <span style={{ color: '#8b949e', fontSize: '12px' }}>or</span>
          <div style={{ flex: 1, height: '1px', background: '#30363d' }} />
        </div>
        ...
        {/* Error / Success */}
        {error && (
          <div style={{ color: '#f85149', fontSize: '13px', marginBottom: '16px', padding: '10px', background: '#2d1515', borderRadius: '6px' }}>
            {error}
          </div>
        )}
        {message && (
          <div style={{ color: '#3fb950', fontSize: '13px', marginBottom: '16px', padding: '10px', background: '#122d1e', borderRadius: '6px' }}>
            {message}
          </div>
        )}
        ...
        <p style={{ textAlign: 'center', color: '#8b949e', fontSize: '13px', margin: 0 }}>
          ...
          <span
            ...
            style={{ color: '#4fa3e3', cursor: 'pointer' }}
          >
