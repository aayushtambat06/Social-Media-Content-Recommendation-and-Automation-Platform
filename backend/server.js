...
// // 1. Generate Auth URL (Called by React frontend)
...
//     prompt: 'consent',
//     state: req.userId,      // Pass Supabase user ID through the Google flow
//     scope: [
...
// // 2. Handle Google Callback & Save Tokens (Called by Google redirect)
// app.get('/api/auth/youtube/callback', async (req, res) => {
//   const code = req.query.code
//   const userId = req.query.state // Recover the user ID from the state variable
...
//     // Save to Supabase 'user_integrations' table
